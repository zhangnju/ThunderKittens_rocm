...
def up_plus_mul(inp: Tensor, gate_inp: Tensor, up_proj: nn.Linear) -> Tensor:
    up = einsum(inp, up_proj, "b i, o i -> b o")
...
O = torch.zeros(
    (batch_size, intermediate_size), device=0, dtype=torch.bfloat16
)  # noqa: E741
