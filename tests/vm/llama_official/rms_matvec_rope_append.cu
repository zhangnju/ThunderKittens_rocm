...
namespace kittens::prototype::vm
{
    ...
    struct rms_qkv_rope_append : BaseOp<Config, Globals>
    {
        ...
        struct pipeline_specifics
        {
            ...
            {
                auto block_idx = inst.start_block_idx + iter;
                tma::prefetch<dim::ROW, cache_policy::EVICT_FIRST>(weight_chunk, g.qkv_weights, {inst.layer_idx, block_idx, col_idx});
            }
        ...
        struct prefetcher
        {
            ...
            {
                parsed_instruction inst{s};
                pipeline::loader_loop<&Globals::attn_norm_weights, true>(s, g, inst.layer_idx);
            }
        };
